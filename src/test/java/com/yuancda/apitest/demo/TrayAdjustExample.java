...
@Slf4j
public class TrayAdjustExample {
    ...
    void pointExchangeRmb() {
        ...
        log.info(sign);
        String res = UrlUtil. openContentType(Conf.host + "/tray/cleanStandard", "application/json", params.toJSONString());
        log.info(res);
    }
